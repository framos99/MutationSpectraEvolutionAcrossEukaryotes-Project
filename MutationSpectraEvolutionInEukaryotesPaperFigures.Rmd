...
## Change tip names
tree$tip.label <- sapply(tree$tip.label, function(old_label) {
...
# Adding Brassica rapa and Brassica oleracea to tree based on position of Brassica napus on the timetree
BrassicaNapus_species <- "Brassica_napus_(Oilseed)"
BrassicaRapa_species <- "Brassica_rapa_(Field_Mustard)"
BrassicaOleracea_species <- "Brassica_oleracea_(Wild_Cabbage)"
BrassicaRapa_divergence_time <- 3
BrassicaOleracea_divergence_time <- 15

# add tips
tree <- bind.tip(tree, BrassicaOleracea_species,
                     where = which(tree$tip.label == BrassicaNapus_species),
                     position = BrassicaOleracea_divergence_time,
                     edge.length = BrassicaOleracea_divergence_time)
tree <- bind.tip(tree, BrassicaRapa_species,
                     where = which(tree$tip.label == BrassicaNapus_species),
                     position = BrassicaRapa_divergence_time,
                     edge.length = BrassicaRapa_divergence_time)
#####
