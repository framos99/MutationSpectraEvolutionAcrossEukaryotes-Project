...
def split_fasta_and_run_repeatmasker(input_fasta, NCBI_TAXONOMY, working_directory, RMSK_output_directory):
    ...
    repeatmasker_command = "bsub -q voltron_long -o {bsub_out_directory} -e {bsub_out_directory} RepeatMasker -species {NCBI_TAXONOMY} -e hmmer -libdir /misc/appl/RepeatMasker-4.1.5/Libraries/ -hmmer_dir /misc/appl/hmmer-3.1b2/bin/ {individual_sequence_fasta}"
    # File paths
